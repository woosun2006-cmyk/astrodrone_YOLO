...
// (0812best.engine for real/Jetson and best_v5_wsl.engine for WSL SITL). An
// existing engine is loaded as-is and is never overwritten on deserialization failure. If no
...
public:
    ...
    // engine_cache_path: e.g. YOLO_MODEL/0812best.engine or
    // YOLO_MODEL/best_v5_wsl.engine - loaded as-is when
