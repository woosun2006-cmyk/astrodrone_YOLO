...
mission::DiagonalApproachGuidanceConfig config() {
    mission::DiagonalApproachGuidanceConfig config;
...
int main() {
    mission::DiagonalApproachGuidance guidance(config());
    ...
    mission::DiagonalApproachGuidance no_horizontal(no_horizontal_config);
    ...
    const auto final_centering = guidance.update(0.0, 80.0, 5.0, 1.0, true, 0.05, 20.0);
    ...
    const auto centered_at_final_distance =
        guidance.update(0.0, 0.0, 5.0, 1.0, true, 0.05, 20.0);
