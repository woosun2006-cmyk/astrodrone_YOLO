...
SIM_ENV_KEYS=(
  ...
  SIM_WORLD SIM_MODEL SITL_FRAME SITL_INSTANCE SITL_LOCATION SITL_SPEEDUP SITL_PARAM_FILE
  GAZEBO_HEADLESS GZ_VERBOSITY GAZEBO_FDM_PORT SITL_MASTER_TCP_PORT
...
export SIM_WORLD SIM_MODEL SITL_FRAME SITL_INSTANCE SITL_LOCATION SITL_SPEEDUP SITL_PARAM_FILE
export GAZEBO_HEADLESS GZ_VERBOSITY GAZEBO_FDM_PORT SITL_MASTER_TCP_PORT
export CONTROL_UDP_PORT TELEMETRY_UDP_PORT GCS_UDP_PORT
...
export MAVLINK_AUDIT_TCP_PORT MAVLINK_AUDIT_REPORT
